...
type MotionImageProps = Omit<ImageProps, 'src'> &
  MotionProps & {
...
export default function AnimatedImage(props: MotionImageProps) {
  const {
    ...
    wrapperClassName,
    // Motion props (extract a safe subset)
    animate,
    initial,
    whileHover,
    whileTap,
  ...
  return (
    ...
    >
      <Image
        {...(imageRest as ImageProps)}
        className={className}
        placeholder={placeholder}
        blurDataURL={blurDataURL}
        src={props.src ?? placeholderBlur}
      />
    </motion.div>
  )
}
